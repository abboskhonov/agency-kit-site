...
// Register fadeUp effect (without ScrollTrigger)
gsap.registerEffect({
  name: "fadeUp",
...
// Register fadeUpOnScroll effect (with ScrollTrigger)
gsap.registerEffect({
  name: "fadeUpOnScroll",
...
// Register staggerFadeUpOnScroll effect (container triggers, children animate with stagger)
gsap.registerEffect({
