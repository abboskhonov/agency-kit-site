...
function HomePage() {
  ...
  return (
    <div className="item-center flex flex-col flex-nowrap p-5">
      ...
      >
        <div role="banner" className="bg-tag-bg w-fit rounded-3xl px-6 py-1 md:mx-auto">
          <p className="text-tag align-middle text-sm">
            <span className="mt-1.5 mr-2 inline-block self-center">
              <Sparkles height={12} width={12} aria-hidden="true" />
            </span>
            AI Strategy & Development
          </p>
        </div>

        <h1 className="heading text-h1 text-text-heading font-semibold md:mx-auto md:w-2/3">
          AI Transformation Partner for Growing Businesses
        </h1>

        <p className="text-caption text-label md:mx-auto md:w-2/3">
          We build, train, & deploy custom-LLMs (GPT4, Mistral, Llama3) and other generative AI
          technologies into products & services at scale — thousands of users & millions of
          interactions.
        </p>
