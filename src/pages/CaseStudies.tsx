      ...
      >
        ...
        <header ref={headingRef} className="mb-8 space-y-4 text-center md:mb-14">
          <div className="bg-tag-bg w-fit rounded-3xl px-6 py-1 md:mx-auto" role="banner">
            <p className="text-tag align-middle text-xs font-medium">Designs That Drive Growth</p>
          </div>

          <h2 id="case-studies-heading" className="text-h2 text-heading text-left md:text-center">
            Recent case studies
          </h2>
