...
function Navbar() {
  ...
  const navLinks = [
    ...
    },
    {
      name: "Testimonials",
      href: "#testimonials",
      description: "Read client feedback and success stories",
    },
    { name: "Research", href: "#research", description: "Access our latest research and insights" },
  ];
            ...
            >
              {navLinks.map((link, index) => (
                <li key={link.name} role="none">
                  <a
                    href={link.href}
                    className="text-text-heading text-foreground/70 hover:text-foreground focus:ring-ring rounded-md px-2 py-1 !text-sm font-medium transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none"
                    role="menuitem"
